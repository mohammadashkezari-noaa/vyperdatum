...
if __name__ == "__main__":
    ...
    parent_dir = r"C:\Users\mohammad.ashkezari\Documents\projects\vyperdatum\untrack\data\raster\PBA\usace2010_col_river_dem_J1328113\Original\*.tif"
    files = glob.glob(parent_dir, recursive=True)[:1]
    crs_from = "EPSG:26910+EPSG:5703"
    crs_to = "EPSG:6340+NOAA:101"
